...
Package license: BSD Modification Variant
...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/repoze.lru-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/repoze.lru-feedstock)
...
Once the `conda-forge` channel has been enabled, `repoze.lru` can be installed with:

```
conda install repoze.lru
```

It is possible to list all of the versions of `repoze.lru` available on your platform with:
